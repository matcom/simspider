...
from Redist.pyfuzzy.doc.structure.dot.dot import register_handler,print_dot
...
register_handler(Redist.pyfuzzy.operator.Compound.Compound,Doc_Compound())
...
import Redist.pyfuzzy.operator.Const
register_handler(Redist.pyfuzzy.operator.Const.Const,Doc_Const())
...
register_handler(Redist.pyfuzzy.operator.Input.Input,Doc_Input())
...
register_handler(Redist.pyfuzzy.operator.Not.Not,Doc_Not())
...
import Redist.pyfuzzy.norm.Norm
register_handler(Redist.pyfuzzy.norm.Norm.Norm,Doc_Norm())
...
import Redist.pyfuzzy.norm.ParametricNorm
register_handler(Redist.pyfuzzy.norm.ParametricNorm.ParametricNorm,Doc_ParametricNorm())
...
register_handler(Redist.pyfuzzy.Adjective.Adjective,Doc_Adjective())
import Redist.pyfuzzy.AdjectiveProxy
register_handler(Redist.pyfuzzy.AdjectiveProxy.AdjectiveProxy,Doc_Adjective())
...
#    label="%(name)s";
    """ % locals())
        ...
        if isinstance(obj.adjective,Redist.pyfuzzy.Adjective.Adjective):
            #out.write("{rank=max;\n")
...
register_handler(Redist.pyfuzzy.Rule.Rule,Doc_Rule())
...
import Redist.pyfuzzy.Variable
register_handler(Redist.pyfuzzy.Variable.Variable,Doc_Variable())
register_handler(Redist.pyfuzzy.OutputVariable.OutputVariable,Doc_OutputVariable())
